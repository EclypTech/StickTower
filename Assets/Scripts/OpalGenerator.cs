...
public class OpalGenerator : MonoBehaviour
{
    ...
    public float OpalRange = 93;           // Opal generate range. Must be a multiple of 3. BUT shouldnt be multiple of Staminarange.
    ...
    void Start()
    {
        ...
        {
            OpalRange += findgenerator.rangeY * 62;                                                 // Increase stamina spawn position.
